...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.House1_Image.setGeometry(QtCore.QRect(100, 120, 121, 131))
        ...
        self.House2_Image.setGeometry(QtCore.QRect(100, 390, 121, 131))
    ...
    def Init(self):
        ...
        # 该页第一间租房
        # 租房名称
        self.House1_Title.setText(self.House_AllInfo[self.currentIndex]['title'])
        # 图片显示
        # (1) 获取图片
        firstPicturePath = self.folder_name + '/' + str(self.currentIndex) + '.jpg'
        # (2)创建图片的图片对象
        firstPicture = QtGui.QPixmap(firstPicturePath)
        # (3)在label上显示图片
        self.House1_Image.setPixmap(firstPicture)
        # 租房信息
        self.House1_Info.setText(self.House_AllInfo[self.currentIndex]['info'])
        # 月租
        self.House1_Price.setText(self.House_AllInfo[self.currentIndex]['price'])
        # 来源
        self.House1_From.setText(self.House_AllInfo[self.currentIndex]['from'])

        # 该页第二间租房
        self.House2_Title.setText(self.House_AllInfo[self.currentIndex + 1]['title'])
        # 图片显示
        # (1) 获取第一张图片
        firstPicturePath = self.folder_name + '/' + str(self.currentIndex + 1) + '.jpg'
        # (2)创建第一张图片的图片对象
        firstPicture = QtGui.QPixmap(firstPicturePath)
        # (3)在label上显示第一张图片
        self.House2_Image.setPixmap(firstPicture)
        self.House2_Info.setText(self.House_AllInfo[self.currentIndex + 1]['info'])
        self.House2_Price.setText(self.House_AllInfo[self.currentIndex + 1]['price'])
        self.House2_From.setText(self.House_AllInfo[self.currentIndex + 1]['from'])
    ...
    def Before(self):
        ...
        # 获取上一页信息
        # 该页第一间租房
        self.House1_Title.setText(self.House_AllInfo[2*self.currentIndex+1]['title'])
        ...
        self.House1_Info.setText(self.House_AllInfo[2*self.currentIndex+1]['info'])
        self.House1_Price.setText(self.House_AllInfo[2*self.currentIndex+1]['price'])
        self.House1_From.setText(self.House_AllInfo[2*self.currentIndex+1]['from'])

        # 该页第二
        self.House2_Title.setText(self.House_AllInfo[2*self.currentIndex+2]['title'])
        # (2) 获取第一张图片
        firstPicturePath = self.folder_name + '/' + str(2*self.currentIndex+2) + '.jpg'
        # (3)创建第一张图片的图片对象
        firstPicture = QtGui.QPixmap(firstPicturePath)
        # (4)在label上显示第一张图片
        self.House2_Image.setPixmap(firstPicture)

        self.House2_Info.setText(self.House_AllInfo[2*self.currentIndex+2]['info'])
        self.House2_Price.setText(self.House_AllInfo[2*self.currentIndex+2]['price'])
        self.House2_From.setText(self.House_AllInfo[2*self.currentIndex+2]['from'])
    ...
    def Next(self):
        print('下一页')
        # 偶数页
        if self.currentIndex == int(len(self.House_AllInfo)//2):
            print('当前为最后一页')
            return
        self.currentIndex += 1
        # 获取下一页信息
